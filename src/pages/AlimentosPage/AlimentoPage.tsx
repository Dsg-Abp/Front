            ...
            <div className="text-black bg-rose-100 rounded-lg p-2">
              {selectedAlimentos.map((alimento) => (
                <div key={alimento._id}>
                  <p>
                    <strong>Calorias(kcal): {alimento["Energia(kcal)"]}</strong>
                  </p>
                  <div>
                    <strong>Proteínas(g): {alimento["Proteína(g)"]}</strong>
                  </div>
                  <div>
                    {alimento["Colesterol(mg)"] != null ? (
                      <p>
                        <strong>
                          Colesterol(mg): {alimento["Colesterol(mg)"]}
                        </strong>
                      </p>
                    ) : (
                      <p>
                        <strong>Colesterol(mg): Não contém</strong>
                      </p>
                    )}
                  </div>
                  <div>
                    <strong>
                      Carboidratos(g): {alimento["Carboidrato(g)"]}
                    </strong>
                  </div>
                  <div>
                    <strong>Magnésio(mg): {alimento["Magnésio(mg)"]}</strong>
                  </div>
                  <div>
                    <strong>Ferro(mg): {alimento["Ferro(mg)"]}</strong>
                  </div>
                  <div>
                    <strong>Sódio(mg): {alimento["Sódio(mg)"]}</strong>
                  </div>
                  <div>
                    <strong>Potássio(mg): {alimento["Potássio(mg)"]}</strong>
                  </div>
                  <div>
                    <strong>Zinco(mg): {alimento["Zinco(mg)"]}</strong>
                  </div>
                  <div>
                    {alimento["VitaminaC(mg)"] != null ? (
                      <p>
                        <strong>
                          Vitamina C(mg): {alimento["VitaminaC(mg)"]}
                        </strong>
                      </p>
                    ) : (
                      <p>
                        <strong>Vitamina C(mg): Não contém</strong>
                      </p>
                    )}
                  </div>
                </div>
